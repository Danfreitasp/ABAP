...
SELECT-OPTIONS: so_ped FOR zfajr_003-id.

CLASS lcl_report DEFINITION.

  PUBLIC SECTION.

    DATA: lt_pedido      TYPE TABLE OF zfajr_003,
          lt_pedido_item TYPE TABLE OF zfajr_004.
    DATA: lt_produto     TYPE TABLE OF zfajr_002.
    DATA: lt_caixa       TYPE TABLE OF zfajr_001.
...
*      CAIXA PEQUENA      - 5
      ...
      LOOP AT lt_caixa INTO DATA(ls_caixa).
        ...
        "Qtde de Volume que sobra
        DATA(lv_mod) = lv_volume_total MOD ls_caixa-volume.

        "Encaixa o resto na caixa menor
